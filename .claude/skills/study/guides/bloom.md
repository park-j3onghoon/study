...
- `softskill`: L5 Evaluate + L6 Create (시나리오 재설계)
...
### Claude Code (AskUserQuestion 가능)
```
Q. 이번 퀴즈에서 몇 점 받을 것 같으세요? (4문항 중)
- 4문항 모두 (자신감 0.95)
- 3문항 (0.75)
- 2문항 (0.50)
- 1문항 이하 (0.20)
...
### Codex (일반 질문)
"이번 퀴즈에서 예상 정답률은? 0.0~1.0 사이 숫자로 답해주세요."
...
- 2회째도 틀리면 해당 weakness 태그에 가중치 1.5x로 등록 (schema-v2.md의 weakness 점수 계산식 참조)
...
- 단, 각 문항마다 어떤 주제인지 먼저 사용자가 식별 → 답 → 채점
