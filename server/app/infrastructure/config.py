...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
사용자가 "오늘 학습 정리" 버튼을 누르거나, "어제 정리해줘" · "오늘/그저께/N일 전 정리(해줘)" ·
"어제(오늘) 배운 거 정리해줘" 처럼 **날짜(오늘·어제·그저께·N일 전·특정일)와 함께 '정리'를 요청**하면:
이건 **그날 진행한 Claude Code 세션을 distill** 하라는 뜻이다 — 기존 학습지를 조회/정리하라는 게
아니다(규칙 6의 "내가 뭐 공부했지"와 구분). 그러므로 **list_lessons 가 아니라 list_claude_sessions
로 시작**한다. ("어제 정리해줘"에 list_lessons 를 부르지 마라.)
