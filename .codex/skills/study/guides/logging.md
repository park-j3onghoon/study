...
`~/git/study/log/history.md`에 누적 기록한다. Codex는 사용자가 종료 처리를 명시 요청한 경우에만 갱신.
...
Quiz 4문항을 Bloom 레벨로 매핑한 뒤, 각 레벨에서 맞춘 문항 수를 기록. 같은 레벨에 2문항이 있을 수 있음. 점진적 힌트 후 맞춘 문항은 0.5점.
